...
def update_notebook(notebook_path):
    ...
    for cell in nb['cells']:
        ...
        if cell['cell_type'] == 'markdown' and len(cell['source']) > 0 and '## Task 3: Evaluate and Analyze Residuals' in cell['source'][0]:
            new_cells.append(ensemble_markdown)
            new_cells.append(ensemble_code)
            cell['source'][0] = cell['source'][0].replace('Task 3', 'Task 4')
            task3_inserted = True
